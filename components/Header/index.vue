    ...
    <header id="masthead" class="site-header">
        ...
        <div class="menu-menu-1-container">
          <ul id="menu-menu-1" class="menu">
            ...
            <ul class="sub-menu">
              <li><NuxtLink to="/">Portfolio Item</NuxtLink></li>
              <li><NuxtLink to="/">Blog Article</NuxtLink></li>
              <li><NuxtLink to="/">Shop Item</NuxtLink></li>
              <li><NuxtLink to="/">Portfolio Category</NuxtLink></li>
            </ul>
            </li>
